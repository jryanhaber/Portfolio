// extracting files to templatable pieces.. this is just the cues for coaching
				...
				// explanation of my thought process:
				 ...
				 // set default first coaching prase prefix
				 var firstCoachingPhrase = "One of your aims is to "
// if type of inquiry is an embodiment inquiry, then set this up accordingly... 
// if type fo inquiry is  intention setting... set it up differently ### TODO
...
function setInjunction() {
			...
			console.log("INTENTION LIST IS NOW 3 "+intentionList);


		// define the starting phrase as a variable so the coaching bot can be used for multiple purposes
		switch(TypeOfInquiry){
			// if not defined, do nothing
			case null: 
			break;
			// if embodiment, leave blank
			case "embodiment":
			firstCoachingPhrase = ""
			...
			// if intention coaching, set as so
			case "intentionCoaching":
						break;
						default:
			firstCoachingPhrase = "One of your aims is to" 
		...
		// INTENTION LIST IS UNDEFINED HERE
	
  switch  (lessonNumber) {
  case 1:
	typed.strings =  [
	firstCoachingPhrase + intentionList[0] + " ^2000<br><br>Are you fulfilling this intent to your satisfaction? ^4000 <br><br>If not, "+ coachingMethodSelection.invitation
  ...
  case 2:
	typed.strings =  [
	firstCoachingPhrase + intentionList[1] + " ^2000 <br><br>Are you fulfilling this intent to your satisfaction? ^4000 <br><br>If not, "+coachingMethodSelection.invitation
...
typed.strings =     [
	...
	firstCoachingPhrase + intentionList[2] + " ^2000 <br><br>Are you fulfilling this intent to your satisfaction? ^4000 <br><br>If not, "+coachingMethodSelection.invitation
				    ]   
    break;
  case 4:
typed.strings =    [
	"Wonderful. ^2000",
	firstCoachingPhrase + intentionList[3] + " ^2000 <br><br>Are you fulfilling this intent to your satisfaction? ^4000 <br><br>If not, "+coachingMethodSelection.invitation
				   ]   
    break;
  case 5:
typed.strings =  [
	...
	firstCoachingPhrase + intentionList[4] + "  ^2000 <br><br>Are you fulfilling this intent to your satisfaction? ^4000 <br><br>If not, "+coachingMethodSelection.invitation
				]  
  break;
...
typed.strings =  [
	...
	firstCoachingPhrase + intentionList[5] + " ^2000 <br><br>Are you fulfilling this intent to your satisfaction? ^4000 <br><br>If not, "+coachingMethodSelection.invitation
				]   
    break;
...
typed.strings =  [
	...
	firstCoachingPhrase + intentionList[6] + " ^2000 <br><br>Are you fulfilling this intent to your satisfaction? ^4000 <br><br>If not, "+coachingMethodSelection.invitation
				]   
    break;
  case 8:
typed.strings =  [
	"Amazing ^2000",
	firstCoachingPhrase + intentionList[7] + " ^2000 <br><br>Are you fulfilling this intent to your satisfaction? ^4000 <br><br>If not, "+coachingMethodSelection.invitation
				]   
    break;
  case 9:
typed.strings =  [
	"Wonderful.^2000",
	firstCoachingPhrase + intentionList[8] + " ^2000 <br><br>Are you fulfilling this intent to your satisfaction? ^4000 <br><br>If not, "+coachingMethodSelection.invitation
				]   
    break;
  case 10:
typed.strings =  [
	"Perfect.^2000",
	firstCoachingPhrase + intentionList[9] + " ^2000 <br><br>Are you fulfilling this intent to your satisfaction? ^4000 <br><br>If not, "+coachingMethodSelection.invitation
				]   
    break;
