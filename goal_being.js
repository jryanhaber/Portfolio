...
// extracting files to templatable pieces.. this is just the cues for coaching
				...
				var botMode = {
					...
					// change goal being coached each time

				}
				var updateGoalBeingCoachedIndex = function(){
					// if defined, add 1
					

				if(goalNumber >= numberOfGoals){ goalNumber = 1}
					else{goalNumber = goalNumber +1;}

					// if(botMode.goalBeingCoached !== "undefined"){
					// 	botMode.goalBeingCoached = 0


					// } else 
					// // if not defined, add set to 0

					// {
						
					// if(lessonNumber >= numberOfLessons)
					// 	botMode.goalBeingCoached = botMode.goalBeingCoached+1
...
function setInjunction() {
  ...
  case 2:
	typed.strings =  [
			"Lets talk about one of your goals.",
			"One of your goals is to "+ openingStatement + inquiryList[0] + "^2000 <br><br>Imagine being who you must be to create this."+
			"<br><br>What is in the way of this? <br><br>^2000"+"Notice what happens in your body being with this question. ^2000 <br><br>I am going to refer to this as an inhibitive somatic posture from here forth <br><br>..."
...
typed.strings =  [
   ...
   "Step 1: Connect to the somatic posture shift that arises when this inhibitive state of being arises"
...
,  " <br> <br> ^4000 ... ^20000"	]   ;
   ...
   case 3:
typed.strings =  [
   "Step 2: Get the Somatic Experience. ^2000 <br><br>Lets connect more to the inhibitive somatic experience posture shift."
