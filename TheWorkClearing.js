...
typed.strings =  [
   ...
   "Next, lets see if there is a judgent of yourself at the heart of this"
,  "See if you can identify a judgment here of yourself."
,  "If what shows up is a judgment of another person."
,  "See if it is a judgment of you."
,  "If its a judgment of someone else that you see, ask if you have the same judgment of yourself <br><br> ^4000 ... "
  ...
  case 11:
typed.strings =  [
"Can you know with absolute certainty that it is true? <br><br> ^4000 ... "
					]   ;    
					break;
  case 12:
typed.strings =  [
"How does it impact you do believe this thought? <br><br> ^4000 ... "				]   ;
    break;
  case 13: 
typed.strings =  [
